...
def load_data(uploaded_file):
    ...
    # 2. Gönüllü Turnover
    df_gon = pd.read_excel(uploaded_file, sheet_name='gonullu.turnover', skiprows=2, header=0)
    ...
    # 4. Çalışan Sayısı
    df_calisan = pd.read_excel(uploaded_file, sheet_name='calisan.sayisi', skiprows=2, header=0)
